...
from uncertainty.literature_baselines import LiteratureBaselineSignals
...
def build_default_runner(
    ...
    def literature_builder(output):
        return LiteratureBaselineSignals(output.responses, log_probs=output.log_probs)

    uncertainty_modules = {
        "whitebox": whitebox_builder,
        "graybox": graybox_builder,
        "blackbox": blackbox_builder,
        "literature": literature_builder,
    }
